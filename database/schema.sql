...
CREATE TRIGGER update_performance_comments_updated_at BEFORE UPDATE ON public.performance_comments FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
